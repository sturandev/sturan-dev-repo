...
const Page = () => {
  return (
    <>
      <div className="bg-color-primary bg-opacity-10 h-screen grid grid-cols-10 gap-4">
        ...
        <div className="col-span-8 mr-24 ml-20">
          ...
          <div className="border-[1px] p-3 ml-4 rounded-lg border-color-gray border-opacity-10">
            <h1>Nama Campagne</h1>
            <p className="flex justify-end -mt-7">Status</p>
            <h1>Deskripsi Campagne</h1>
            <h1>Kapan Berakhir</h1>
            <h1>Berapa dana yang di butuhkan</h1>
          </div>
        </div>
      </div>
    </>
