...
const Page = () => {
  ...
  return (
    <>
      <header className="bg-color-primary border-b-2 border-color-gray border-opacity-10 p-6 mb-4 rounded-xl shadow-xl fixed bottom-0 left-0 w-full lg:hidden z-50 ">
        ...
        {menuOpen && (
          <div className="lg:hidden mt-4 space-y-2">
            ...
            <Link href="/proposals" className="block p-2 text-color-neutral">
              Proposals
            </Link>
            <Link href="/claim_xtr" className="block p-2 text-color-neutral">
              Claim XTR
            </Link>
            <Link href="https://github.com/Sturan-Dev/WhitePaper" target="_blank" className="block p-2 text-color-neutral">
              About XTR
            </Link>
          </div>
        )}
      ...
      <div className="bg-color-primary bg-opacity-10 h-[1200px] grid grid-cols-10 gap-4 pt-20 lg:pt-0">
        <div className="hidden lg:block col-span-2 border border-color-gray p-3 rounded-lg ml-20 mt-10 -mr-16 border-opacity-10 h-[400px]">
          ...
          <div className="mt-4 space-y-2 font-semibold flex flex-col">
            ...
            <Link href="https://github.com/Sturan-Dev/WhitePaper" target="_blank" className="px-4 py-2 relative overflow-hidden">
              <span>About XTR</span>
              <span className="line"></span>
            </Link>
          </div>
        ...
        <Participate className="lg:hidden" />
      </div>
    </>
  );
};
